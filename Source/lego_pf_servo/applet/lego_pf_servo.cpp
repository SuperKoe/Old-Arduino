...
void directrun(uint8_t output, Servo servo, struct servopos conf);
void Combo_PWM_mode(uint8_t A_output, uint8_t B_output);
void pwmrun(uint8_t output, Servo servo, struct servopos conf);
...
struct servopos conf1 = {0, 90, 180};
struct servopos conf2 = {0, 90, 180};
